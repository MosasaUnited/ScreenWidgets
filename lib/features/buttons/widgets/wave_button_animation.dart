...
/// [WaveButtonAnimation] is a custom button that creates wave effect when pressed
...
class WaveButtonAnimation extends StatefulWidget {
  const WaveButtonAnimation({
    super.key,
    required this.child,
  ...
  final Widget child;
  @override
  State<WaveButtonAnimation> createState() => _WaveButtonAnimationState();
}

class _WaveButtonAnimationState extends State<WaveButtonAnimation>
