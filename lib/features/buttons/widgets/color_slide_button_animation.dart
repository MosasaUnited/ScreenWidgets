...
import 'package:screens/features/buttons/enums/slide_positions.dart';
...
/// [ColorSlideButtonAnimation] is pretty button that slides in a color when button is tapped
...
class ColorSlideButtonAnimation extends StatefulWidget {
  const ColorSlideButtonAnimation({
    super.key,
    this.bgColor = kBlack,
  ...
  @override
  State<ColorSlideButtonAnimation> createState() => _ColorSlideButtonAnimationState();
}

class _ColorSlideButtonAnimationState extends State<ColorSlideButtonAnimation>
