...
/// [SlideIconButtonAnimation] is an animated slide icon button
...
///
class SlideIconButtonAnimation extends StatefulWidget {
  const SlideIconButtonAnimation({
    super.key,
  ...
  @override
  State<SlideIconButtonAnimation> createState() => _SlideIconButtonAnimationState();
}

class _SlideIconButtonAnimationState extends State<SlideIconButtonAnimation>
