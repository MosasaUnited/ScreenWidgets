...
/// [FuzzyButtonAnimation] makes glowing effect when tapping in mobile devices or hovering it in web
/// The button slides up a little bit when tapping or hovering
class FuzzyButtonAnimation extends StatefulWidget {
  const FuzzyButtonAnimation({
    super.key,
    required this.label,
  ...
  @override
  State<FuzzyButtonAnimation> createState() => _FuzzyButtonAnimationState();
}

class _FuzzyButtonAnimationState extends State<FuzzyButtonAnimation>
