...
/// [BorderButtonAnimation] is an animated button
/// that creates a border from left bottom and top right at the same time when pressed the button in mobile devices
class BorderButtonAnimation extends StatefulWidget {
  const BorderButtonAnimation({
    super.key,
    this.borderWidth = s1,
  ...
  final Color bgColor;
  @override
  State<BorderButtonAnimation> createState() => _BorderButtonAnimationState();
}

class _BorderButtonAnimationState extends State<BorderButtonAnimation>
