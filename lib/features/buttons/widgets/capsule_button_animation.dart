...
/// [CapsuleButtonAnimation] is an animated button that contains a leading icon and a label
...
class CapsuleButtonAnimation extends StatefulWidget {
  const CapsuleButtonAnimation({
    super.key,
    this.labelStyle,
    required this.label,
    this.bgColor = kBlack,
  ...
  @override
  State<CapsuleButtonAnimation> createState() => _CapsuleButtonAnimationState();
}

class _CapsuleButtonAnimationState extends State<CapsuleButtonAnimation>
